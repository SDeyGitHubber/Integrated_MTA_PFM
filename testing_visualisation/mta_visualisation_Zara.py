...
from models.mta_model_Zara import DeepLSTMModel_Zara  # Adjust import if needed
...
if __name__ == "__main__":
    ...
    model = DeepLSTMModel_Zara().to(device)
    checkpoint = torch.load('checkpoints/mta_trajectory_model_Zara_5eps.pth', map_location=device)
